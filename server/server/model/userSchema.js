...
userSchema.methods.generateAuthToken = async function () {  //we use a method of userschema
    try {
        let tokenNew = jwt.sign({ _id: this._id }, "MYNAMEISSAADANSARIIAMADEVLOPERANDPRO");//it takes payload(must be unique ex->_id) and secret/private key [options,callback]
